...
//    private final static String HOST = "192.168.2.128";
    private final static String dbName = "cloud";
    ...
    static {
        try {
            ...
            opt.connectionsPerHost = 20;
            opt.threadsAllowedToBlockForConnectionMultiplier = 60;           
    ...
    public static DBCollection getCollection(String collection) {
        return mg.getDB(dbName).getCollection(collection);
    }
