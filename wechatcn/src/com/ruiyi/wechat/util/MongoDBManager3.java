 ...
 */
public class MongoDBManager3 {

	private static MongoClient mg = null;
	private static DB db = null;
	private final static MongoDBManager3 instance = new MongoDBManager3();
	// private static final String USER = "iwtxokhtd";
	// private static final String PASSWORD = "123456";
	// private static boolean loginSuccess=false;
	private final static String DB = "offset";
	 ...
	 * @throws Exception
	 */
	public static MongoDBManager3 getInstance() throws Exception {
		return instance;
	}
	 ...
	 */
	/*
	 * public DBObject findById(String collection, String _id) { DBObject obj =
	 * new BasicDBObject(); obj.put("_id", ObjectId.massageToObjectId(_id));
	 ...
	 * @throws Exception
	 */
	public List<DBObject> find(String collection, DBObject object)
			throws Exception {
		DBCollection coll = getCollection(collection);
	...
	public List<DBObject> find(String collection, DBObject object,
			DBObject object1) throws Exception {
		DBCollection coll = getCollection(collection);
	...
	public static Iterator<DBObject> aggregate(String collection,
			DBObject object, DBObject object1) throws Exception {
		DBCollection coll = getCollection(collection);
